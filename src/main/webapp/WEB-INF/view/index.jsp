                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="${pageContext.request.contextPath}/content/ui/img/photos/girl1.png" class="user-image" alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="${pageContext.request.contextPath}/content/ui/img/photos/girl1.png" class="img-circle" alt="User Image">
                                <p>
                                    TZHSWEET的小妞
                                    <small>2016年注册</small>
                                </p>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="${pageContext.request.contextPath}/content/ui/img/photos/girl1.png" class="img-circle" alt="用户头像">
                </div>
...
<script type="text/javascript">
    ...
    var ctx = '${ctx}';
    $(function() {
        addTabs(({ id: '10008', title: '欢迎页', close: false, url: '${ctx}/welcome' }));
        App.fixIframeCotent();
        var menus = [
            { id: "10010", text: "我的工作台", isHeader: true },
            {
                ...
                icon: "fa fa-circle-o",
                children: [
                    { id: "100012", text: "用户管理", url: "${ctx}/sys/user/index?type=", targetType: "iframe-tab", icon: "fa fa-square" },
                    { id: "100014", text: "角色管理", url: "${ctx}/sys/role/index?type=", targetType: "iframe-tab", icon: "fa fa-square" }
                ]
            }

        ];
        /*$('.sidebar-menu').sidebarMenu({ data: menus, param: { strUser: 'admin' } });*/
        $('.sidebar-menu').sidebarMenu({ url: "${ctx}/sys/menu/getMenuListByUserName", param: { userName: '<shiro:principal/>' } });
