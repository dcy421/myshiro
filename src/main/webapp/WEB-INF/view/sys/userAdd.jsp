            ...
            <form class="form-horizontal" id="form-admin-add"  onsubmit="return false;">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input id="birthday" class="form-control" onClick="WdatePicker({maxDate:'%y-%M-%d'})" name="birthday" type="text"  />
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label">禁用该用户</label>
                        <div class="col-sm-7">
                            <label>
                                <input type="checkbox" name="locked" value="1" class="minimal">
                            </label>
                            <%--<div class="col-sm-4">
        ...
        $("#form-admin-add").validate({
            rules:{
                username:{
                    ...
                    maxlength:16,
                    remote: {
                        url: "${ctx}/sys/user/getRepeatUserName",     //后台处理程序
                        type: "post",               //数据发送方式
            ...
            submitHandler:function(form){
                ...
                $.ajax({
                    ...
                    type: "Post",
                    dataType : "json",
                    data:  $("#form-admin-add").serialize()+"&flag=add&roleids="+roleids,
