...
$(function() {
    $table.bootstrapTable({
        ...
        columns : [ {
            ...
            title : '生日',
            field : 'birthday', // 字段
            align : 'center', // 对齐方式（左 中address 右）
            valign : 'middle', //
    ...
    $add.click(function () {
        layer_show("老师添加","/teacher/teacherAdd","800","530");
    ...
    $edit.click(function () {
        if (selections.length != 1) {
            ...
            layer_show("老师修改","/teacher/teacherUpd?id="+selections[0],"800","600");
    ...
    $export.click(function () {
        $('#teacherForm').attr('action', "/teacher/exportTeacherList");
        $('#teacherForm').submit();
    });
